...
import { Home, FileText, FileEdit } from "lucide-react";

const links = [
  { name: "Home", href: "home", icon: Home },
  { name: "Alta Paciente", href: "altaPaciente", icon: FileText },
  { name: "Tratamiento", href: "tratamiento", icon: FileEdit },
];
            ...
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex-1 px-3 bg-white divide-y space-y-1">
                <ul className="space-y-2 pb-2">
                  {links.map((link) => {
                    const Icon = link.icon; // <<--- Esto permite iterar el icono dinámico

                    return (
                      <li key={link.href}>
                        <Link
                          href={link.href}
                          className="flex items-center gap-3 p-2 rounded-lg text-base capitalize text-gray-900 font-normal hover:bg-gray-100 group"
                        >
                          {/* Icono */}
